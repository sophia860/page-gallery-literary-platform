    ...
    <div className={`${cardo.className} min-h-screen flex flex-col items-center justify-center px-4 relative`} style={{ background: "linear-gradient(180deg, #f5f0ea 0%, #ede7df 100%)", lineHeight: 1.7 }}>
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-medium text-[#2a2a2a] mb-2" style={{ fontStyle: "italic" }}>Welcome back</h1>
          <p className="text-sm text-[#999]">Return to your garden</p>
        </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#d4cdc4] rounded text-sm bg-white focus:outline-none focus:border-[#7da078] transition-colors pr-10"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-[#666] cursor-pointer">
                <input type="checkbox" className="rounded border-[#d4cdc4]" />
                Remember me
              </label>
              <Link href="/garden/forgot-password" className="text-sm text-[#b07d4f] hover:text-[#8a5f3a] transition-colors">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-[#999] mt-6">
          New here?{" "}
          <Link href="/garden/signup" className="text-[#b07d4f] hover:text-[#8a5f3a] transition-colors">
